...
class Editor():
    ...
    def initialize_gui(self):
        ...
        self.window = gui.Application.instance.create_window("Something", 420, 420)
        ...
        _widget3d.frame = gui.Rect(0, self.window.content_rect.y, 420, self.window.content_rect.height)

        mesh = o3d.geometry.TriangleMesh.create_sphere()
        mesh.compute_vertex_normals()

        _widget3d.scene.add_geometry(self.cloud_structs[0].name, self.cloud_structs[0].cloud, material)
        _widget3d.scene.set_background([0.5, 0.5, 0.5, 0.25])
        _widget3d.setup_camera(60, o3d.geometry.OrientedBoundingBox.create_from_points(self.cloud_structs[0].cloud.points), [0, 0, 0])
