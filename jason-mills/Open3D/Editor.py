...
class Editor():
    ...
    def initialize_gui(self):
        self.window = gui.Application.instance.create_window("Something", 500, 500)
        
        _widget3d = gui.SceneWidget()
        _widget3d.scene = rendering.Open3DScene(self.window.renderer)
        material = rendering.MaterialRecord()
        material.shader = "defaultLit"
        _widget3d.frame = gui.Rect(0, self.window.content_rect.y, 500, self.window.content_rect.height)
        ...
        _widget3d.scene.set_background([0.5, 0.5, 0.5, 0.4])
        bounding_box = self.cloud_structs[0].cloud.get_axis_aligned_bounding_box()
        _widget3d.setup_camera(30, bounding_box, [0, 0, 0])
