...
namespace C3PO.ViewModel
{
    internal class SettingsViewModel : ViewModelBase
    {
        ...
        private int _noOfRotations;
        public int NoOfRotations
        {
            get
            {
                return _noOfRotations;
            }
            set
            {
                _noOfRotations = value;
                OnPropertyChanged(nameof(NoOfRotations));
            }
        }
        ...
        public SettingsViewModel(NavigationStore ns)
        {
            ...
            ImportSettingsCommand = new CommandImportSettings(this);
            ExportSettingsCommand = new CommandExportSettings(this);
